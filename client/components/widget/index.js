...
export default function Widget(props) {
  ...
  <div className="card-body">
    ...
    <br /><br />
    <button type='submit' className='bg-blue-500 hover:bg-blue-600 duration-300 items-center justify-center -mt-3 w-full py-2 rounded-xl text-base text-white normal-caseoutline-none border-none font-bold -mb-2'>
                {
                    loading 
