...
export default function Widget(props) {
  ...
  <div className="card-body">
    ...
    <br /><br />
    <button type='submit' className='-mt-3 shadow-xl btn w-full text-base text-[#05050a] normal-case bg-white hover:bg-white outline-none border-none font-bold -mb-2'>
                {
                    loading 
