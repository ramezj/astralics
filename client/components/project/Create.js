...
export default function Create() {
    ...
    return (
        <>
        <button className='btn bg-gray-900 border-none normal-case font-medium hover:bg-gray-900' onClick={()=>window.my_modal_1.showModal()}>Create Project</button>
<dialog id="my_modal_1" className="modal bg-transparent">
  <form method="dialog" className="modal-box bg-gray-900">
    ...
    <div className="modal-action">
      <button className="btn bg-gray-950 border-none hover:bg-gray-950 normal-case -mt-5">Close</button>
    </div>
  </form>
</dialog>
        </>
