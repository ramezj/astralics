    ...
    return (
        ...
        <center>
            <br/>
                  ...
                  <button className='mt-2 outline-none w-4/5 py-2 bg-zinc-950 text-white rounded-lg font-medium flex justify-center items-center gap-2 duration-300' onClick={signIn}>
