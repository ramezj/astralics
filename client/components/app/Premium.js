...
export default function Premium(props) {
    ...
    })} className=''><span className="flex w-48 items-center alertShadow align-middle cursor-pointer bg-red-600 text-white text-md font-bold px-10 py-2 rounded-full dark:bg-red-600 dark:text-white">
        Upgrade Plan
        </span></a> <>
      </></>
    }
