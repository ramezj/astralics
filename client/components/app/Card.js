...
export default function Card(props) {
    ...
    const copyLink = (e) => {
      navigator.clipboard.writeText(`https://astralics.com${props.href}`)
      setisCopied(true);
    }
    function closeModal() {
      setIsOpen(false)
    ...
    <div className="card border border-black/10 dark:border-white/10 w-96 bg-white hover:border-black/10 hover:bg-gray-200 dark:bg-black hover:dark:bg-zinc-950 cursor-pointer duration-200 outline-none rounded-lg">
