...
export default function Card(props) {
    ...
    <span className='shadow-lg -mt-6 -mr-2 w-10 h-8 rounded-lg justify-center items-center float-right flex backgroundColor hover:scale-[1.18] duration-300'>
    <Link className='float-right flex justify-center ' href='/test' >
    <CodeBracketIcon className='text-white' width={24} height={24} strokeWidth={'2'}/>
    </Link>
    </span>
    <span className='shadow-lg -mt-6 -mr-2 w-10 h-8 rounded-lg justify-center items-center float-right flex backgroundColor hover:scale-[1.18] duration-300'>
    <Link href={`${props.settings}`} className='float-right flex justify-center'>
