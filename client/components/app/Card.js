...
export default function Card(props) {
    return (
        <>
    <Link className="card w-96 backgroundColor shadow-xl hover:bg-gray-900 cursor-pointer duration-300 outline-none" href={props.href}>
  <div className="card-body">
    ...
    <Link href={`${props.settings}`} className='-mt-4 hover:animate-spin'>
