...
/>
        ...
        <button onClick={upvoteFeedback} className="group hover:bg-black duration-100 w-[4.5rem] h-12 shadow-sm bg-black border-2 border-black rounded-xl items-center flex justify-center">
