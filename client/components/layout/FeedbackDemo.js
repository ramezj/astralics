...
export default function FeedbackDemo(props) {
    ...
    return (
        <>
                <div key={props.id} className="border hover:border-black/30 dark:hover:border-white/20 dark:border-white/10 border-black/10 w-full flex bg-gray-200 dark:bg-zinc-900 rounded-lg items-center cursor-pointer duration-300">
