...
export default function Page() {
  ...
  return (
    ...
    <center>
        <br />
    <h1 className="text-3xl font-bold text-black dark:text-white">💡 Feature Requests </h1>
            <br /><br />
            <NewBoard session={session} id={router.query.id} dropdownText={'Feature Requests'}>
                <br /><br /><br />
                <Spinner />
                <br />
            </NewBoard>
        ...
        <center>
            ...
            <h1 className="text-3xl font-bold text-black dark:text-white">💡 Feature Requests </h1>
            <br /><br />
            <NewBoard session={session} setSort={setSort} sort={sort} id={router.query.id} dropdownText={'Feature Requests'}>
            {
                    session 
                    ? 
                    <>
