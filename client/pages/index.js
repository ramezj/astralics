      ...
      <center>
        <div className="">
          ...
          >
            ...
            transition={{duration: 0.8}}
            className='
            sm:text-5xl 2xl:text-7xl 2xl:mt-14 text-4xl w-4/5 font-bold tracking-tight leading-none text-transparent bg-clip-text text-white md:text-5xl lg:text-5xl lg:mt-8 lg:w-3/6 sm:mt-8 mt-8'>
