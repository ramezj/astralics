...
export default function Component() {
  ...
  return (
    <Layout>
      <center>
        <div className="">
            <h1 className='sm:text-5xl 2xl:text-7xl 2xl:mt-16 text-4xl w-4/5 font-bold tracking-tight leading-none text-white md:text-5xl lg:text-5xl lg:mt-4 lg:w-3/6'>
